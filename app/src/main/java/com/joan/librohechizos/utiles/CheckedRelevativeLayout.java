...
public class CheckedRelevativeLayout extends RelativeLayout implements Checkable {
    ...
    public CheckedRelevativeLayout(Context context) {
        super(context);
    }

    public CheckedRelevativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
